 ...
 */
public class Fragmenttwo_basketball extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view=inflater.inflate(R.layout.fragmenttwo_basketball, container, false);
        fragmenttwo_listview_detailinfo=(ListView)view.findViewById(R.id.fragmenttwo_listview_basketballinfo);
...
//               HashMap<String,String> map=Web_Json.getJson(result);
            ...
            public void onFinished() {
                Log.e("yjq","完成");
                mData.add(new fragmenttwo_info("篮球赛","2020/3/8","一起来打篮球吧，我们","图片",""));
...
//        mData.add(new fragmenttwo_info("篮球赛","2020/3/8","一起来打篮球吧，我们","图片"));
//        mData.add(new fragmenttwo_info("篮球赛","2020/3/9","一起来打篮球吧，我们","图片"));
//        mData.add(new fragmenttwo_info("篮球赛","2020/3/10","一起来打篮球吧，我们","图片"));
//        mData.add(new fragmenttwo_info("篮球赛","2020/3/11","一起来打篮球吧，我们","图片"));
//        adapter=new fragmenttwo_info_adapter(mData,view.getContext());
//        fragmenttwo_listview_detailinfo.setAdapter(adapter);
        return view;
    }

    public static Fragmenttwo_basketball newInstance() {
        
        Bundle args = new Bundle();
        
        Fragmenttwo_basketball fragment = new Fragmenttwo_basketball();
